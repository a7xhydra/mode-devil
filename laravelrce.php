...
function Help() {
    echo "
    url=URL // Pasang Url Target Disini
    Optionals:
    key=APP_KEY // Pasang App Key Disini
    function=system // Function ex : system, passthru
    method=1 // Pilih method 1 - 4 Required function parameter, 5 - 6 ( Eval mode )
    contoh : url=web.go.id key=¥¥576€fgrdwfrfghg methode=1
    ". PHP_EOL;
}
